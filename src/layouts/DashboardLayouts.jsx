    ...
    <div className="min-h-screen bg-base-100">
      ...
      <div className="drawer lg:drawer-open pt-16">
        ...
        <div className="drawer-content flex flex-col bg-base-200/50">
          {/* Dashboard Top Nav */}
          <nav className="navbar w-full bg-base-100 border-b border-base-300 px-4 sticky top-0 z-10">
            ...
            <div className="flex-1">
              <h1 className="px-4 font-bold text-lg tracking-tight text-base-content">
                {getTitle()}
              </h1>
            </div>
          </nav>
          ...
          <div className="p-4 sm:p-6 lg:p-8 grow">
            <div className="bg-base-100 rounded-2xl shadow-sm border border-base-300 min-h-full p-4">
              <Outlet />
            </div>
          </div>
        </div>
        ...
        <div className="drawer-side z-30">
          <label htmlFor="my-drawer-4" className="drawer-overlay"></label>
          <div className="flex min-h-full flex-col items-start bg-base-100 border-r border-base-300 pt-20 sm:pt-4 is-drawer-close:w-16 is-drawer-open:w-72 transition-all">
            {/* User Profile Mini-Section */}
            <div className="px-4 py-6 w-full is-drawer-close:hidden">
            ...
            <ul className="menu w-full px-3 gap-1">
              ...
              {(user.role === "rider" ||
                ...
                <li>
                  <Link
                    to="/"
                    className={`rounded-xl py-3 ${isActive("/") ? "active bg-primary text-primary-content" : ""}`}
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 24 24"
              ...
              {user.role === "admin" && (
                <li>
                  <Link
                    to="/dashboard"
                    className={`rounded-xl py-3 ${isActive("/dashboard") ? "active bg-primary text-primary-content" : ""}`}
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 24 24"
              ...
              {user.role === "admin" && (
                <li>
                  <Link
                    ...
                    className={`rounded-xl py-3 ${isActive("/dashboard/driver-management") ? "active bg-primary text-primary-content" : ""}`}
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 24 24"
                    ...
                    >
                      ...
                      <path d="M3 21v-2a4 4 0 0 1 4-4h4"></path>
                      <circle cx="18" cy="17" r="3"></circle>
                      <path d="M18 14v1m0 4v1m-3-2h1m4 0h1"></path>
                    </svg>
                    <span className="font-medium is-drawer-close:hidden">
                      Driver Management
                    </span>
              ...
              {user.role === "admin" && (
                <li>
                  <Link
                    ...
                    className={`rounded-xl py-3 ${isActive("/dashboard/user-management") ? "active bg-primary text-primary-content" : ""}`}
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 24 24"
              ...
              {user.role === "driver" && (
                <li>
                  <Link to="/dashboard" className="rounded-xl py-3">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 24 24"
                      strokeLinejoin="round"
              ...
              {(user.role === "rider" ||
                ...
                <li>
                  <Link
                    ...
                    className={`rounded-xl py-3 ${isActive("/dashboard/profile") ? "active bg-primary text-primary-content" : ""}`}
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 24 24"
